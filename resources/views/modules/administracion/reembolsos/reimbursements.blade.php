@extends('modules.administracion.reembolsos.index')
                ...
                <div id="uuid-panel" class="hidden"
                    ...
                    <div style="display:flex; gap:.75rem; margin-bottom:.75rem;">
                        <div style="position:relative; flex:1;">
                            ...
                            <input type="text" id="search-uuid"
                    ...
                    <div class="fh-row fh-row-middle">
                        <div>
                            ...
                            <div class="check-group">
                                <label class="check-opt"><input type="radio" name="tipo_gasto" value="viaje"
                                        checked><span>Gastos por Viaje</span></label>
                                <label class="check-opt"><input type="radio" name="tipo_gasto"
                                        value="operacion"><span>Gastos por Operación</span></label>
                                <label class="check-opt"><input type="radio" name="tipo_gasto"
                        ...
                        <div>
                            ...
                            <div class="check-group">
                                <label class="check-opt"><input type="radio" name="payment" value="efectivo"
                                        checked><span>Efectivo</span></label>
                                <label class="check-opt"><input type="radio" name="payment"
                                        value="tc"><span>T.C.</span></label>
                                <label class="check-opt"><input type="radio" name="payment"
                                        value="td"><span>T.D.</span></label>
                                <div style="display:flex;align-items:center;gap:.5rem;margin-left:.5rem;">
                                    ...
                                    <input type="text" id="modal-num-tc" class="input-field" style="width:160px;"
                    ...
                    <div class="fh-row fh-row-bottom">
                        <div class="fh-field">
                            ...
                            <input type="text" id="modal-nombre"
                                value="{{ $userData['nombre'] ?? 'Saul Falcon Perez' }}" class="input-field" readonly>
                        </div>
                        <div class="fh-field">
                            <label>Lugar</label>
                        ...
                        <div class="fh-field">
                            ...
                            <input type="text" id="modal-motivo" class="input-field"
                    ...
                    <div class="table-scroll">
                        <table class="expense-table">
                            ...
                            <tbody id="table-body">
                                ...
                                <tr class="cat-row">
                                    <td colspan="9"><i class="bx bxs-plane-alt"></i> Vuelos y / o Transporte</td>
                                </tr>
                                @for ($i = 0; $i < 5; $i++)
                                    <tr class="data-row">
                                        <td>
                                            <div class="date-wrap"><i class="bx bx-calendar"></i><input type="text"
                                                    class="cell-input date-in" placeholder="DD/MM/AAAA" data-fp></div>
                                        </td>
                                        <td><input type="text" class="cell-input" placeholder="—"></td>
                                        <td><input type="text" class="cell-input" placeholder="—"></td>
                                        <td><input type="number" oninput="calcTotal()" class="cell-input num c-sub"
                                                placeholder="0.00"></td>
                                        <td><input type="number" oninput="calcTotal()" class="cell-input num c-sub"
                                                placeholder="0.00"></td>
                                        <td><input type="number" oninput="calcTotal()" class="cell-input num c-sub"
                                                placeholder="0.00"></td>
                                        <td><input type="number" oninput="calcTotal()" class="cell-input num c-ish"
                                                placeholder="0.00"></td>
                                        <td><input type="number" oninput="calcTotal()" class="cell-input num c-iva"
                                                placeholder="0.00"></td>
                                ...
                                <tr class="cat-row">
                                    <td colspan="9"><i class="bx bx-restaurant"></i> Restaurantes y / o Comidas</td>
                                </tr>
                                @for ($i = 0; $i < 4; $i++)
                                    <tr class="data-row">
                                        <td>
                                ...
                                {{-- COMBUSTIBLE --}}
                                <tr class="cat-row">
                                    <td colspan="9"><i class="bx bxs-gas-pump"></i> Combustible</td>
                                </tr>
                                @for ($i = 0; $i < 3; $i++)
                                    <tr class="data-row">
                                        <td>
                                ...
                                {{-- OTROS --}}
                                <tr class="cat-row">
                                    <td colspan="9"><i class="bx bx-package"></i> Otros</td>
                                </tr>
                                @for ($i = 0; $i < 4; $i++)
                                    <tr class="data-row">
                                        <td>
