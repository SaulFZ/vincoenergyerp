                        ...
                        <div class="modules-grid">
                            ...
                            <div class="mod-card">
                                ...
                                <div class="mod-card-body" id="systems-body">
                                    <label class="perm-row"><input type="checkbox" name="permissions[systems][user-management]"><span class="perm-check-icon"><i class="fas fa-check"></i></span><span>Gestión de roles</span></label>
                                    <label class="perm-row"><input type="checkbox" name="permissions[systems][tickets]"><span class="perm-check-icon"><i class="fas fa-check"></i></span><span>Gestión de tickets</span></label>
                                </div>
                            </div>
