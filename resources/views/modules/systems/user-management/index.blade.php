...
<head>
    ...
    <link href="{{ asset('assets/css/systems/user-management/index.css') }}" rel="stylesheet">
</head>
...
<body>
        ...
        <div class="panel">
            ...
            <div class="pagination-bar">
                ...
                <div class="pag-controls">
                    <button class="pag-btn" id="firstPage" title="Primera"><i
                    ...
                    <button class="pag-btn" id="lastPage" title="Última"><i
                            ...
                            <div class="photo-col">
                                ...
                                <div class="photo-btns">
                                    <input type="file" id="photoInput" accept="image/*"
                                        style="width: 0; height: 0; position: absolute; opacity: 0; overflow: hidden;">
                                    <button type="button" class="btn-photo-change"
                                        onclick="document.getElementById('photoInput').click()">
                                        <i class="fas fa-upload"></i> Cambiar
                                    </button>
                                    <button type="button" class="btn-photo-remove" id="removePhotoBtn"
                                        style="display:none;">
                            ...
                            <div class="fields-col">
                                <div class="fields-row">
                                    <div class="field-group" style="position:relative;">
                                        ...
                                        <div id="employeeSuggestions" class="suggestions-dropdown"
                            ...
                            <div class="modules-grid">
                                ...
                                <div class="mod-card">
                                    ...
                                    <div class="mod-card-body" id="administracion-body">
                                        <label class="perm-row"><input type="checkbox"
                                                name="permissions[administration][expense-claims]"><span
                                                class="perm-check-icon"><i class="fas fa-check"></i></span><span>Gestión
                                                de
                                                reembolsos</span></label>
                                    </div>
                                </div>
                                ...
                                <div class="mod-card">
                                    ...
                                    <div class="mod-card-body" id="qhse-body">
                                        <label class="perm-row"><input type="checkbox"
                                                name="permissions[qhse][management]"><span class="perm-check-icon"><i
                                                    class="fas fa-check"></i></span><span>management</span></label>
                                        <label class="perm-row"><input type="checkbox"
                                                name="permissions[qhse][vescap]"><span class="perm-check-icon"><i
                                                    class="fas fa-check"></i></span><span>VESCAP</span></label>
                                        <label class="perm-row"><input type="checkbox"
                                                name="permissions[qhse][incidents]"><span class="perm-check-icon"><i
                                                    class="fas fa-check"></i></span><span>Incidencias</span></label>
                                        <label class="perm-row"><input type="checkbox"
                                                name="permissions[qhse][auditorias]"><span class="perm-check-icon"><i
                                                    class="fas fa-check"></i></span><span>Auditorías</span></label>
                                    </div>
                                </div>
                                ...
                                <div class="mod-card">
                                    ...
                                    <div class="mod-card-body" id="ventas-body">
                                        <label class="perm-row"><input type="checkbox"
                                                name="permissions[ventas][clientes]"><span class="perm-check-icon"><i
                                                    class="fas fa-check"></i></span><span>Clientes</span></label>
                                        <label class="perm-row"><input type="checkbox"
                                                name="permissions[ventas][cotizaciones]"><span
                                                class="perm-check-icon"><i
                                                    class="fas fa-check"></i></span><span>Cotizaciones</span></label>
                                        <label class="perm-row"><input type="checkbox"
                                                name="permissions[ventas][oportunidades]"><span
                                                class="perm-check-icon"><i
                                                    class="fas fa-check"></i></span><span>Oportunidades</span></label>
                                    </div>
                                </div>
                                ...
                                <div class="mod-card">
                                    ...
                                    <div class="mod-card-body" id="rh-body">
                                        <label class="perm-row"><input type="checkbox"
                                                name="permissions[rh][orgmanagement]"><span class="perm-check-icon"><i
                                                    class="fas fa-check"></i></span><span>Altas de
                                                empleados</span></label>
                                        <label class="perm-row"><input type="checkbox"
                                                name="permissions[rh][loadchart]"><span class="perm-check-icon"><i
                                                    class="fas fa-check"></i></span><span>L&amp;O Chart</span></label>
                                    </div>
                                </div>

                                <div class="mod-card">
                                    <div class="mod-card-head" onclick="toggleModule('systems-body')">
                                        <div class="mod-card-left">
                                            <span class="mod-icon mod--sistemas"><i
                                                    class="fas fa-laptop-code"></i></span>
                                            <span class="mod-name">systems</span>
                                        </div>
                                        <label class="tog" onclick="event.stopPropagation()">
                                            <input type="checkbox" class="module-toggle" data-module="systems">
                                            <span class="tog-track"><span class="tog-thumb"></span></span>
                                        </label>
                                    </div>
                                    <div class="mod-card-body" id="systems-body">
                                        <label class="perm-row"><input type="checkbox"
                                                name="permissions[systems][user-management]"><span
                                                class="perm-check-icon"><i class="fas fa-check"></i></span><span>Gestión
                                                de roles</span></label>
                                        <label class="perm-row"><input type="checkbox"
                                                name="permissions[systems][inventory-it]"><span
                                                class="perm-check-icon"><i class="fas fa-check"></i></span><span>Gestión
                                                de inventario</span></label>
                                        <label class="perm-row"><input type="checkbox"
                                                name="permissions[systems][tickets]"><span class="perm-check-icon"><i
                                                    class="fas fa-check"></i></span><span>Gestión de
                                                tickets</span></label>
                                    </div>
                                </div>
                                ...
                                <div class="mod-card">
                                    ...
                                    <div class="mod-card-body" id="suministro-body">
                                        <label class="perm-row"><input type="checkbox"
                                                name="permissions[suministro][pedidos]"><span class="perm-check-icon"><i
                                                    class="fas fa-check"></i></span><span>Pedidos</span></label>
                                    </div>
                                </div>

                                <div class="mod-card">
                                    <div class="mod-card-head" onclick="toggleModule('operations-body')">
                                        <div class="mod-card-left">
                                            <span class="mod-icon mod--operaciones"><i
                                                    class="fas fa-industry"></i></span>
                                            <span class="mod-name">Operaciones</span>
                                        </div>
                                        <label class="tog" onclick="event.stopPropagation()">
                                            <input type="checkbox" class="module-toggle" data-module="operations">
                                            <span class="tog-track"><span class="tog-thumb"></span></span>
                                        </label>
                                    </div>
                                    <div class="mod-card-body" id="operations-body">
                                        <label class="perm-row">
                                            <input type="checkbox" name="permissions[operations][sgc-ves]">
                                            <span class="perm-check-icon"><i class="fas fa-check"></i></span>
                                            <span>SGC VES</span>
                                        </label>
                                ...
                                <div class="mod-card">
                                    ...
                                    <div class="mod-card-body" id="almacen-body">
                                        <label class="perm-row"><input type="checkbox"
                                                name="permissions[almacen][inventario]"><span class="perm-check-icon"><i
                                                    class="fas fa-check"></i></span><span>Inventario</span></label>
                                    </div>
                                </div>
                                ...
                                <div class="mod-card">
                                    ...
                                    <div class="mod-card-body" id="geociencias-body">
                                        <label class="perm-row"><input type="checkbox"
                                                name="permissions[geociencias][exploraciones]"><span
                                                class="perm-check-icon"><i
                                                    class="fas fa-check"></i></span><span>Exploraciones</span></label>
                                        <label class="perm-row"><input type="checkbox"
                                                name="permissions[geociencias][analisis]"><span
                                                class="perm-check-icon"><i
                                                    class="fas fa-check"></i></span><span>Análisis</span></label>
                                    </div>
                                </div>
    ...
    <script src="{{ asset('assets/js/systems/user-management/index.js') }}?v=1.1"></script>
</body>
