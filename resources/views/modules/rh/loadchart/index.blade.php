...
<head>
    ...
    <link href="{{ asset('assets/css/rh/loadchart/index.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/css/rh/loadchart/calendar.css') }}" rel="stylesheet">
...
<body>
    <header class="header-main">
        ...
        <nav class="nav-main">
            <a href="#" class="nav-link" data-route="calendar">
            ...
            @if (\App\Helpers\PermissionHelper::hasDirectPermission('ver_gestionRyA'))
                <a href="#" class="nav-link" data-route="review_assignments">
                    <i class="fas fa-tasks"></i> Gestión de RyA
                </a>
            @endif

            @if (\App\Helpers\PermissionHelper::hasDirectPermission('ver_gestion_bonos'))
                <a href="#" class="nav-link" data-route="field_bonuses">
                    <i class="fas fa-money-bill-wave"></i> Bonos
                </a>
            @endif
    ...
    <script src="{{ asset('assets/js/rh/loadchart/index.js') }}"></script>
    <script src="{{ asset('assets/js/rh/loadchart/calendar.js') }}"></script>
