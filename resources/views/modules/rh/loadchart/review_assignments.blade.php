...
@section('content')
    ...
    <div class="assignment-container">
        <div class="control-panel">
            ...
            {{-- ✅ CAMBIO A FILTRO DE ÁREA --}}
            <div class="filter-group">
                <label for="area-filter" class="filter-label">Área</label>
            ...
            <table class="assignment-table">
                <thead>
                    <tr>
                        ...
                        {{-- ✅ AHORA MOSTRAMOS ÁREA Y DEPARTAMENTO --}}
                        <th data-sort="area">Área<i class="fas fa-sort"></i></th>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Variables del DOM
            const areaFilter = document.getElementById('area-filter'); // ✅ AHORA ES AREA
            ...
            function loadEmployees(page = 1) {
                const area = areaFilter.value; // ✅ Usamos el valor del área
                ...
                employeesTableBody.innerHTML = `
                    <tr>
                        <td colspan="9"> <div class="loading-message">
                ...
                const params = new URLSearchParams({
                    area: area, // ✅ Pasamos area en lugar de department
                    per_page: perPage,
                    page: page,
                    search: searchQuery,
                ...
                fetch(`${urlGetEmployees}?${params.toString()}`, {
                    ...
                    .then(data => {
                        if (data.employees.length === 0) {
                            employeesTableBody.innerHTML = `
                                <tr>
                                    <td colspan="9"> <div class="no-results-message">
                        ...
                        return fetch(urlGetAssignments, {
                            ...
                            .then(assignments => {
                                ...
                                data.employees.forEach(employee => {
                                    ...
                                    // ✅ Obtenemos nombres de Área y Departamento de forma segura
                                    const empArea = employee.area ? employee.area.name : 'N/A';
                                    ...
                                    <td><strong>${empArea}</strong></td> <td>${empDept}</td> <td>${employee.position || 'N/A'}</td>
                    ...
                    .catch(error => {
                        ...
                        employeesTableBody.innerHTML = `
                            <tr>
                                <td colspan="9" class="text-center text-danger"> Error al cargar los empleados. Por favor, intente nuevamente.
                                </td>
                            </tr>
                        `;
            ...
            // ✅ Event listeners para los filtros y búsqueda (Actualizados al Área)
