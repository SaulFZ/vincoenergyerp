                ...
                <div id="uuid-panel" class="hidden"
                    ...
                    <div id="drop-zone-container" class="hidden" style="border-top:1px solid #334155; padding-top:1rem;">
                        <div id="drop-zone"
                            ...
                            <small
                                style="display:block;margin-top:.25rem;font-size:.75rem;font-weight:600;color:#14b8a6;text-transform:uppercase;">Arrastra tu .XML aquí</small>
                        ...
                        <div class="fh-grid-4">
                            ...
                            <div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="modal-depto" value="{{ $userData['departamento'] ?? 'Desarrollo' }}" class="input-field" readonly>
                                </div>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="modal-motivo" class="input-field modal-focusable" placeholder="Ej. Viáticos proyecto foráneo">
                                </div>
                            </div>
                        </div>
                                ...
                                <tr class="cat-row">
                                    <td colspan="10">
                                        <div style="display:flex; justify-content:space-between; align-items:center;">
                                            ...
                                            <button type="button" class="btn-add-row" onclick="addRow('cat-vuelos')" title="Agregar Fila">
                                ...
                                <tr class="cat-row">
                                    <td colspan="10">
                                        <div style="display:flex; justify-content:space-between; align-items:center;">
                                            ...
                                            <button type="button" class="btn-add-row" onclick="addRow('cat-restaurantes')" title="Agregar Fila">
                                                <i class="bx bx-plus"></i>
                                            </button>
                                        </div>
                                    </td>
                                ...
                                <tr class="cat-row">
                                    <td colspan="10">
                                        <div style="display:flex; justify-content:space-between; align-items:center;">
                                            ...
                                            <button type="button" class="btn-add-row" onclick="addRow('cat-combustible')" title="Agregar Fila">
                                                <i class="bx bx-plus"></i>
                                            </button>
                                        </div>
                                    </td>
                                ...
                                <tr class="cat-row">
                                    <td colspan="10">
                                        <div style="display:flex; justify-content:space-between; align-items:center;">
                                            ...
                                            <button type="button" class="btn-add-row" onclick="addRow('cat-otros')" title="Agregar Fila">
                                                <i class="bx bx-plus"></i>
                                            </button>
                                        </div>
                                    </td>
    ...
    <script>
        ...
        function renderDashboard() {
            ...
            let filtered = requests.filter(req => {
                ...
                const matchSearch = !searchQuery || req.motivo.toLowerCase().includes(searchQuery) || req.folioP.toLowerCase().includes(searchQuery) || req.folioU.toLowerCase().includes(searchQuery);
        ...
        function removeRow(btn) {
            ...
            if(tbody.querySelectorAll('.data-row').length > 1) { row.remove(); calcTotal(); }
            else { showToast('Debe haber al menos una fila en esta categoría.', 'warning'); }
        }
        ...
        function openModalForCreate() {
            resetModalForm();
            document.getElementById('main-modal-title').innerHTML = '<i class="bx bx-receipt"></i> Formato de <strong>Reembolso</strong>';
        ...
        function verDetalles(id) {
            ...
            if(!req) return;
            resetModalForm();
            document.getElementById('main-modal-title').innerHTML = '<i class="bx bx-show"></i> Detalles de <strong>Reembolso</strong>';
        ...
        function evaluarSolicitud(id) {
            ...
            if(!req) return;
            resetModalForm();
            document.getElementById('main-modal-title').innerHTML = '<i class="bx bx-check-shield"></i> Evaluar <strong>Reembolso</strong>';
        ...
        /* ── TOGGLE PANEL UUID ── */
        function toggleUuidPanel() { document.getElementById('uuid-panel').classList.toggle('hidden'); }
        ...
        function verifyAndSubmit() {
            ...
            if (!centroCostos) { showToast('Selecciona un Centro de Costos.', 'error'); return; }
        ...
        function saveDraft() {
            ...
            if (!motivo) { showToast('Necesitas al menos un motivo para guardar el borrador.', 'warning'); return; }
