    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            async function fetchAndRenderBonuses() {
                try {
                    const url = new URL('/recursoshumanos/loadchart/field-bonuses-data', window.location
                        .origin);
            ...
            async function saveBonus() {
                ...
                let url = '/recursoshumanos/loadchart/field-bonuses';
            ...
            async function editBonus(bonusId) {
                try {
                    const response = await fetch(`/recursoshumanos/loadchart/field-bonuses/${bonusId}/edit`);
            ...
            async function toggleBonusStatus(bonusId) {
                try {
                    const response = await fetch(
                        `/recursoshumanos/loadchart/field-bonuses/${bonusId}/toggle-status`, {
                            method: 'POST',
                            headers: {
                                'X-CSRF-TOKEN': csrfToken,
                                'Accept': 'application/json'
            ...
            async function deleteBonus() {
                try {
                    const response = await fetch(`/recursoshumanos/loadchart/field-bonuses/${currentBonusId}`, {
                        method: 'DELETE',
                        headers: {
                            'X-CSRF-TOKEN': csrfToken,
                            'Accept': 'application/json'
